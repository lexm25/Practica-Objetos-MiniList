...
public class MyReflection {
	...
	/**
	 * Metodo que devuelve el numero de atributos que tiene la clase
	 * @param className
	 * @return
	 * @throws Exception
	 */
	public static int cuentaAtributos(String className)throws Exception{
		Class<?> clase = Class.forName(className);
	 ...
	 * @throws Exception
	 */
	public static String getFieldTypeName(String className, String fieldName) throws Exception{
		Field field = Class.forName(className)
			      .getDeclaredField(fieldName);
